// Always use the environment variable when set.
// For local dev:      set NEXT_PUBLIC_API_URL=http://localhost:8000/api/v1
// For production:     the deployed Render backend is used by default.
// Override in Vercel via NEXT_PUBLIC_API_URL env var if the backend changes.
const API_BASE = process.env.NEXT_PUBLIC_API_URL || 'https://managermant-stu-backe.onrender.com/api/v1';
